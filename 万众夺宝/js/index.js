...
var subpages = ['index.index.html', 'classify.html','new_announce.html', 'cart.cartlist.html', 'user.html'];
var subpagesName = ['首页', '全部商品', '最新揭晓', '购物车', '我'];
var subpage_style = {
	top: '0px',
	bottom: '50px'
};
...
function tableSwitch() {
	...
	mui('.mui-bar-tab').on('tap', 'li', function() {
		...
		$('.mui-bar-tab a').removeClass("no");
		$(this).children("a").addClass("no");
